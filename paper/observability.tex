...
\title{WatchTower: An Agent's Self-Report Is Not Ground Truth\\
\large Trajectory- and Host-Level Forensics for Multi-Agent AI Systems}

\author{\IEEEauthorblockN{Anonymous Submission}\\Proof-of-Concept Artifact --- Under Review}
...
cost threshold. All numbers are reproducible from the released artifacts.
...
classes---it never sees the signal. \textsc{WatchTower} also beats naive cost (loops/entropy
catch what pure cost misses; pure cost false-positives on expensive-but-correct work).
